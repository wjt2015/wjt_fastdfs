...
DESTDIR=$FASTDFS_ALL_HOME/fastdfs
...
#指定本机配置:
LIBS="$LIBS -L$FASTDFS_ALL_HOME/libfastcommon/lib"
echo "new_LIBS=",$LIBS

##CFLAGS="$CFLAGS -static -I${FASTDFS_ALL_HOME}/libfastcommon/include"

CFLAGS="$CFLAGS -I${FASTDFS_ALL_HOME}/libfastcommon/include"

echo "CFLAGS="$CFLAGS
echo "1,2="$1,$2
ENABLE_STATIC_LIB=1
echo "ENABLE_STATIC_LIB="${ENABLE_STATIC_LIB}
